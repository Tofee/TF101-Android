...
static const struct tegra_emc_table picasso_emc_tables_hynix_300Mhz[] = {
	{
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
static const struct tegra_emc_table picasso_emc_tables_elpida_400Mhz[] = {
	{
...
static const struct tegra_emc_chip picasso_emc_chips[] = {
	{
...
static const struct tegra_emc_chip picasso_t25_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = -1,
		.table = picasso_emc_tables_elpida_400Mhz,
		.table_size = ARRAY_SIZE(picasso_emc_tables_elpida_400Mhz)
	},
};

static const struct tegra_emc_chip picasso_hynix_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = 0x5454,
		.table = picasso_emc_tables_hynix_300Mhz,
		.table_size = ARRAY_SIZE(picasso_emc_tables_hynix_300Mhz)
	},
};

static const struct tegra_emc_chip picasso_elpida_emc_chips[] = {
	{
		.description = "Elpida 300MHz",
		.mem_manufacturer_id = 0x0303,
...
{
	/* TODO: detect */
	tegra_init_emc(picasso_elpida_emc_chips, ARRAY_SIZE(picasso_elpida_emc_chips));
