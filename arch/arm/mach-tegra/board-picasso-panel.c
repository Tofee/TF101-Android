...
#define picasso_hdmi_enb	TEGRA_GPIO_PV5

/*panel power on sequence timing*/
#define picasso_pnl_to_lvds_ms	0
#define picasso_lvds_to_bl_ms	200
...
int __init picasso_panel_init(void)
{
	...
	tegra_gpio_enable(picasso_hdmi_enb);
	gpio_request(picasso_hdmi_enb, "hdmi_5v_en");
	gpio_direction_output(picasso_hdmi_enb, 1);
