...
static char *picasso_battery[] = {
	"battery",
};

static struct gpio_charger_platform_data picasso_charger_pdata = {
	.name = "ac",
	.type = POWER_SUPPLY_TYPE_MAINS,
	.gpio = AC_PRESENT_GPIO,
	.gpio_active_low = 1,
	.supplied_to = picasso_battery,
	.num_supplicants = ARRAY_SIZE(picasso_battery),
};

static struct platform_device picasso_charger_device = {
	.name = "gpio-charger",
	.dev = {
		.platform_data = &picasso_charger_pdata,
	},
};
