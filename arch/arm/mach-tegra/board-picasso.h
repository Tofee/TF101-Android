...
/* WM8903 GPIOs */
#define PICASSO_GPIO_WM8903(_x_)	(TEGRA_NR_GPIOS + 32 + (_x_))
...
#define TEGRA_DEVKIT_MISC_HW_0_PROJECT_DEFAULT  0x0UL //PICASSO(EP101)
 ...
 *   @ret unsigned int
 *      Project identification will be returned. (eg, PICASSO(EP101) <-> 101)
 ...
 *      No return parameter
 *      Project name will be assigned according to different kinds devices. (PICASSO, PICASSOG, PICASSO-WIMAX, and SL101)
 */
